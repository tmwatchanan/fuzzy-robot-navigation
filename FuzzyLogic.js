...
//Behavior coefficient B0
function behavior_coefficient_bo_very_low(B) {
    if (0 <= B && B <= 0.25) return (0.25 - B) / 0.25;
    else return 0;
}
...
function behavior_coefficient_bo_mod(B) {
    if (0.25 <= B && B <= 0.75) return 1 - Math.abs(B - 0.5) / 0.25;
    else return 0;
}

function behavior_coefficient_bo_high(B) {
    if (0.5 <= B && B <= 1.0) return 1 - Math.abs(B - 0.75) / 0.25;
    else return 0;
}

function behavior_coefficient_bo_very_high(B) {
    if (0.75 <= B < 1.0) return (0.75 - B) / -0.25;
    else if (B >= 1.0) return 1;
    else return 0;
}

//Behavior coefficient Bt, Bw and Bwd
function behavior_coefficient_very_very_low(B) {
    if (0 <= B <= 1 / 6) return ((1 / 6) - B) / (1 / 6)
    else return 0;
}

function behavior_coefficient_very_low(B) {
    if (0 <= B && B <= 1 / 3) return 1 - Math.abs(B - (1 / 6)) / (1 / 6);
    else return 0;
}

function behavior_coefficient_low(B) {
    if (1 / 6 <= B && B <= 1 / 2) return 1 - Math.abs(B - (1 / 3)) / (1 / 6);
    else return 0;
}

function behavior_coefficient_mod(B) {
    if (1 / 3 <= B && B <= 2 / 3) return 1 - Math.abs(B - (1 / 2)) / (1 / 6);
    else return 0;
}

function behavior_coefficient_high(B) {
    if (1 / 2 <= B && B <= 5 / 6) return 1 - Math.abs(B - (2 / 3)) / (1 / 6);
    else return 0;
}

function behavior_coefficient_very_high(B) {
    if (2 / 3 <= B && B <= 1) return 1 - Math.abs(B - (5 / 6)) / (1 / 6);
    else return 0;
}

function behavior_coefficient_very_very_high(B) {
    if (5 / 6 <= B && B < 1) return ((5 / 6) - B) / (-1 / 6);
