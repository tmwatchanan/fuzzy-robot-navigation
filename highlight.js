setInterval(function highlight() {
    // if (Dwpt["near"] != 0) document.getElementById("btDwpt[near]").style.backgroundColor = "#ffa"
    // else document.getElementById("btDwpt[near]").style.backgroundColor = "white";

    // if (Dwpt["mid"] != 0) document.getElementById("btDwpt[mid]").style.backgroundColor = "#ffa";
    // else document.getElementById("btDwpt[mid]").style.backgroundColor = "white";

    // if (Dwpt["far"] != 0) document.getElementById("Dwpt[far]").style.backgroundColor = "#ffa";
    // else document.getElementById("Dwpt[far]").style.backgroundColor = "white";

    // if (Dobs["near"] != 0) document
    ...
    document.getElementById("bwd").style.backgroundColor = "white";
            ...
            for (var dwpt = 1; dwpt <= 3; dwpt++) {
                ...
                if (isAnyBox) {
                    if (Math.min(x, y, z) != 0) {
                        ...
                        console.log(ruleid, dwptid, dobsid, awpt_obs, awpt_obsid, dobs)
                    }
                }
            }
        }
